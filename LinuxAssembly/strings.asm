...
_start:
   ...
   mov eax, 4     ; system call to write data
   mov ebx, 1     ; std out 
   mov ecx, input1  ; puts message 1 in the ecx register which will have some action performed on it based on eax and ebx values (write data out)
   mov edx, 10  ; sets the length of the expected output
   int 0x80       ; calls the kernel and output the message
